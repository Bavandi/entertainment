...
@Component({
  selector: 'be-branded-events',
  templateUrl: './branded-events.component.html',
  styleUrls: ['./branded-events.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BrandedEventsComponent implements OnInit, AfterViewInit {
