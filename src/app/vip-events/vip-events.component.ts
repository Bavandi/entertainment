...
@Component({
  selector: 'be-vip-events',
  templateUrl: './vip-events.component.html',
  styleUrls: ['./vip-events.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class VipEventsComponent implements OnInit, AfterViewInit {
