...
@Component({
  selector: 'be-fun-party',
  templateUrl: './fun-party.component.html',
  styleUrls: ['./fun-party.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FunPartyComponent implements OnInit, AfterViewInit {
