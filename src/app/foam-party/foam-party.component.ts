...
@Component({
  selector: 'be-foam-party',
  templateUrl: './foam-party.component.html',
  styleUrls: ['./foam-party.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FoamPartyComponent implements OnInit, AfterViewInit {
