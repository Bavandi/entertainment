...
@Component({
  selector: 'be-light-party',
  templateUrl: './light-party.component.html',
  styleUrls: ['./light-party.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class LightPartyComponent implements OnInit, AfterViewInit {
