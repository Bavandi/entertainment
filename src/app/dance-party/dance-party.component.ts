...
@Component({
  selector: 'be-dance-party',
  templateUrl: './dance-party.component.html',
  styleUrls: ['./dance-party.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DancePartyComponent implements OnInit, AfterViewInit {
