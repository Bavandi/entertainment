...
@Component({
  selector: 'be-costume-party',
  templateUrl: './costume-party.component.html',
  styleUrls: ['./costume-party.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CostumePartyComponent implements OnInit, AfterViewInit {
