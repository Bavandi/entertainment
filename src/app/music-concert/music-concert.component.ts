...
@Component({
  selector: 'be-music-concert',
  templateUrl: './music-concert.component.html',
  styleUrls: ['./music-concert.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MusicConcertComponent implements OnInit, AfterViewInit {
